...
public class ConflictException extends RuntimeException {
    ...
    public ConflictException(String message, String errorCode, Map<String, Object> context) {
        super(message);
        this.errorCode = errorCode;
    ...
    private void logStructuredError() {
        ...
        log.warn("Conflito de negócio: {} - Código: {} - Contexto: {}", getMessage(), errorCode, context);
