...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Resposta da atualização de authority")
public class AuthorityUpdateResponseDTO {

    @Schema(description = "ID único da authority", example = "123e4567-e89b-12d3-a456-426614174000")
    private UUID id;

    @Schema(description = "Nome da authority", example = "USER_WRITE")
    private String name;

    @Schema(description = "Descrição da authority", example = "Permissão para escrita de usuários")
