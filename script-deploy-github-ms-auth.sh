...
# Build Maven, Push (Commit SHA + latest) e Deploy Local do ms-auth (Spring Boot)
#
# Uso:
#   ./script-deploy-github-ms-auth.sh up       # Commit, Push GHCR + Sobe no Docker Local
#   ./script-deploy-github-ms-auth.sh          # Commit, Push GHCR (sem subir local)
# =============================================================================
