#!/bin/bash
# =============================================================================
# 🚀 MINI MANUAL DE USO — script-deploy-github-ms-auth.sh (ms-auth)
# =============================================================================
...
#      $ ./script-deploy-github-ms-auth.sh
#      -> Envia para a branch ativa (ex: develop) e gera as tags:
#         ghcr.io/keepguard/ms-auth:develop-<sha>
#         ghcr.io/keepguard/ms-auth:develop-latest
#
#   2. Commit, push, build e deploy imediato no Docker Compose local:
#      $ ./script-deploy-github-ms-auth.sh up
...
#      $ ./script-deploy-github-ms-auth.sh merge main
...
#      $ ./script-deploy-github-ms-auth.sh merge main up
#
#   5. Pipeline Completo em 1 comando (Merge 'main' + Docker Local + K8s Produção):
#      $ ./script-deploy-github-ms-auth.sh merge main up prod
#      OU simplesmente:
#      $ ./script-deploy-github-ms-auth.sh full
