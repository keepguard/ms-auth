...
# =============================================================================
# Uso:
#   ./script-deploy-github-ms-auth.sh up             # Incrementa patch no POM + Deploy Docker
#   ./script-deploy-github-ms-auth.sh 1.0.5 up       # Define versão explícita + Deploy Docker
#   ./script-deploy-github-ms-auth.sh                # Incrementa patch no POM + GitHub Registry apenas
#   ./script-deploy-github-ms-auth.sh --current up   # Mantém versão atual do POM + Deploy Docker
# =============================================================================
